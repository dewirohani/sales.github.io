@extends('layouts.app', [
    ...
    'activePage' => 'register',
    'backgroundImage' => asset('assets') . "/img/ptt.jpg",
])
              ...
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-check text-left">
                  <label class="form-check-label">
                    ...
                    {{ __('I agree to the') }}
                    <a href="#something" style="color:white">{{ __('terms and conditions') }}</a>.
                  </label>
                </div>
                <div class="card-footer ">
                  <button type="submit" style="background-color:#082032" class="btn btn-primary btn-round btn-lg">{{__('REGISTER')}}</button>
                </div>
              </form>
            </div>
          </div>
