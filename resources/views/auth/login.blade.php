@extends('layouts.app', [
    ...
    'activePage' => 'login',
    'backgroundImage' => asset('assets') . "/img/pergudangan.jpg",
])
    ...
    <div class="content">
        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain text-center">
                ...
                <h4 class="card-title">{{ __('LOGIN USER') }}</h4>
                </div>
                <div class="card-body ">
                ...
                <button  type = "submit" style="background-color:#082032" class="btn btn-primary btn-round btn-lg btn-block mb-3">{{ __('LOGIN') }}</button>
                <div class="pull-left">
                    <h6>
