      ...
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            ...
            enctype="multipart/form-data">
              ...
              <div class="card-footer ">
                <button type="submit" class="btn btn-primary btn-round" style="background-color:#035397">{{__('Save')}}</button>
              </div>
              <hr class="half-rule"/>
            </form>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="card-footer ">
              <button type="submit" class="btn btn-primary btn-round " style="background-color:#035397" >{{__('Change Password')}}</button>
            </div>
          </form>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="author">
              <a href="#">
                ...
                <h5 class="title" style="color:#035397">{{ auth()->user()->name }}</h5>
              </a>
              <p class="description">
                  {{ auth()->user()->email }}
              </p>
