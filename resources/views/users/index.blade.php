        ...
        <div class="fixed-plugin">
            <div class="dropdown show-dropdown">
              ...
              <li class="header-title"> Sidebar Background</li>
                    ...
                    <span class="badge filter badge-yellow" data-color="black"></span>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
              ...
              <button class="btn btn-primary btn-round text-white pull-right"  style="background-color:#035397" href="#">Add user</button>
