...
<div class="panel-header panel-header-sm"></div>
  <div class="content">
    <div class="row">
       <button id="create_event" style="margin-top:38px; margin-left:750px; background-color:#035397 " type="button" class="btn btn-md" data-toggle="modal" data-target="#create_event_modal">
       <i class="fa fa-plus"></i> Add</button>
       <button id="create_event" style="background-color:#035397; margin-top:38px " type="button" class="btn btn-md" data-toggle="modal" data-target="#edit_event_modal">
       <i class="fa fa-edit"></i> Edit</button>
       <button id="create_event" style="background-color:#035397; margin-top:38px " type="button" class="btn btn-md" data-toggle="modal" data-target="#remove_event_modal">
          ...
          <div class="modal-dialog" >
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;sa</button>
              ...
              <div class="modal-body">
                ...
                <form id="create_event_frm"  action="{{route('event')}}"  method="post" enctype="multipart/form-data"  >
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-xs-12">
                      <div class="form-group">
                        <input type="date" name="tanggal" id="tanggal" required=""  class="form-control" style="height:38px; margin-bottom:10px;" placeholder="Tanggal">
                        <input type="text" name="event_title" id="event_title" required=""  class="form-control" placeholder="Nama Creator">
                    ...
                    <div class="pull-left" style="width: 75%;">
                      ...
                      <div class="col-lg-2 col-xs-2">
                        <div id="start_time_toggle">
                            <button type="button"  class="btn btn-md" style="background-color:#035397"  title="Add Start Time" onclick="add_start_time()"> 
                      ...
                      <div class="col-lg-5 col-xs-12" id="event_start_time_area" style="display: none">
                        <!--                                 none-->
                        <div class="form-group">
                          <input type="text"   name="event_start_time" id="event_start_time" value="12:00 AM" class="form-control time_pick" style="margin-left:20px" placeholder="Start Time">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right" >
                      <div class="col-lg-2 col-xs-2">
                        <div id="end_date_toggle">
                          <button type="button" class="btn btn-md" style="background-color:#035397" onclick="add_end_date()" style="width: 117px" >
                          <i class="fa fa-plus" style="color:white"></i> End Date</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="pull-left" style="width: 75%;">
                      ...
                      <div class="col-lg-2 col-xs-2">
                        <div id="end_time_toggle">
                          <button type="button"  class="btn btn-md" style="background-color:#035397"  title="Add End T35e"  onclick="add_end_time()"> 
                          <i class="fa fa-plus" style="color:white"></i>
                          <i class="fa fa-clock" style="color:white"></i>
                          </button>  
                        </div>
                      ...
                      <div class="col-lg-5 col-xs-12" id="event_end_time_area" style="display: none">
                        <!--                    //none-->
                        <input type="text"   name="event_end_time" id="event_end_time" value="11:59 PM" class="form-control time_pick" style="margin-left:20px; height:35px"  placeholder="End Time">
                      </div>
                    </div>
                    <div class="pull-right">
                      <div class="col-lg-2 col-xs-2">
                        <button type="button" class="btn btn-md" onclick="remove_end_date()" style="width:117px; background-color:#035397" > <i class="text-danger fa fa-times" style="color:white; "></i> Remove</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section" style="margin-top: 10px">
                    ...
                    <p class="text-right">
                        <button type="button" id="create_event_btn" style="background-color:#548CA8" class="btn btn-primary">Save</button>
          ...
          <div class="modal-dialog" >
            <div class="modal-content admin-form">
              ...
              <div class="modal-body">
                ...
                <form id="edit_event_frm" action="{{route('event')}}"  method="post" enctype="multipart/form-data"  >
                     {{ csrf_field() }}
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <input type="date" name="tanggal" id="edit_tanggal" required=""  class="form-control" placeholder="Tanggal">
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-xs-12">
                      <div class="form-group">
                        <label class="">Nama Creator</label>
                        <input type="text" name="nama_creator" id="edit_event_title" required=""  class="form-control" placeholder="Nama Creator">
                      </div>
                      <input type="hidden" id="edit_event_id" value="" name="id" />  
                      <input type="hidden" id="edit_set_start_time_data" value="Yes" />  
                      <input type="hidden" id="edit_set_end_time_data" value="Yes" />  
                    ...
                    <div class="pull-left" style="width: 75%;">
                      ...
                      <div class="col-lg-2 col-xs-2">
                        <div id="edit_start_time_toggle" class="mt30">
                          <button type="button"  class="btn btn-md" title="Remove Start Time" style="color:white; background-color:#035397"   onclick="edit_remove_start_time()"> 
                          <i class="fa fa-plus" style="color:white"></i>
                          <i class="fa fa-clock" style="color:white"></i>
                          </button>  
                        </div>
                      ...
                      <div class="col-lg-5 col-xs-12" id="edit_event_start_time_area" style="display: block">
                        <div class="form-group">
                          <label class="" style="margin-left:15px" >Start Time</label>
                          <input type="text"   name="event_start_time" id="edit_event_start_time" value="" class="form-control time_pick" style="margin-left:15px" placeholder="Start Time">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right" >
                      <div class="col-lg-2 col-xs-2">
                        <div id="edit_end_date_toggle" class="mt30" style="display: none" >
                          <button type="button" class="btn btn-md" onclick="edit_add_end_date()" style="width: 117px; background-color:#035397" >
                          <i class="fa fa-plus" style="color:white"></i>
                          </i> End Date</button>
                        </div>
                      </div>
                    ...
                    <div class="pull-left" style="width: 75%;">
                      ...
                      <div class="col-lg-2 col-xs-2">
                        <div id="edit_end_time_toggle" class="mt30">
                          <button type="button"  class="btn btn-md" title="Remove End Time" style="background-color:#035397"  onclick="edit_remove_end_time()"> 
                          <i class="fa fa-plus" style="color:white"></i>
                          <i class="fa fa-clock" style="color:white"></i>
                          </button>  
                        </div>
                      ...
                      <div class="col-lg-5 col-xs-12" id="edit_event_end_time_area" style="display: block">
                        <div class="form-group">
                          <label class="" style="margin-left:15px">End Time</label>
                          <input type="text"   name="event_end_time" id="edit_event_end_time" value="" class="form-control time_pick" style="margin-left:15px"  placeholder="End Time">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right"> 
                      <div class="col-lg-2 col-xs-2 mt30" >
                        <button type="button" class="btn btn-md" onclick="edit_remove_end_date()" style="width: 117px; background-color:#035397" > <i class="fa fa-times" style="color:white;"></i> Remove</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section" style="margin-top: 10px">
                    <p class="text-right">
                      <button type="button" id="edit_event_btn" style="background-color:#548CA8" class="btn btn-primary">Update</button>
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    </p>
                  </div>
                  <!-- end section row -->
